  ...
  return (
    <div className="">
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              <div
                className={`p-3 rounded-2xl bg-gray-100 ${stat.color.replace("text", "bg")}/10`}
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl  border border-gray-100">
          <EarningChart></EarningChart>
        </div>

        {/* Order Status */}
        <div className="lg:col-span-4 bg-white rounded-3xl  border border-gray-100">
          <OrderChart></OrderChart>
        </div>

        {/* Recent Orders Table */}
        <div className="lg:col-span-12 bg-white rounded-3xl p-4 border border-gray-100">
            ...
            <table className="w-full min-w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="text-left py-4 font-medium text-gray-500 text-sm">
                    Order ID
                  </th>
                  <th className="text-left py-4 font-medium text-gray-500 text-sm">
                    Customer
                  ...
                  <th className="text-right py-4 font-medium text-gray-500 text-sm">
                    Amount
                  </th>
                  <th className="text-center py-4 font-medium text-gray-500 text-sm">
                    Status
                  </th>
                </tr>
              </thead>
